...
load("/Users/mingyuqi/Desktop/netsimures/graphon2/b06/simu01/eval.Rdata")
setwd("/Users/mingyuqi/Desktop/netsimures/graphon2/b06/simu01")
...
source('/Users/mingyuqi/Desktop/netsimures/graphon2/b06/simu01/legend.R')
...
d1<-melt(d1,id.vars='g')
d1<-d1[,as.list(smean.sd(value)),.(g,variable)]
d1[,ymin:=Mean-1.66*SD/sqrt(50)]
d1[,ymax:=Mean+1.66*SD/sqrt(50)]
